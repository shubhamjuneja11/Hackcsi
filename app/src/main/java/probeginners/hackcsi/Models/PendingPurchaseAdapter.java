 ...
 */
public class PendingPurchaseAdapter<T> extends BaseAdapter {
    ...
    public PendingPurchaseAdapter(Query mRef, Class<T> mModelClass, int mLayout, Activity activity) {
        this.mRef = mRef;
    ...
    protected void populateView(View view, T model){
       ...
       PurchaseInfo order=(PurchaseInfo) model;
        ...
        t3=(TextView)view.findViewById(R.id.b_mrp);

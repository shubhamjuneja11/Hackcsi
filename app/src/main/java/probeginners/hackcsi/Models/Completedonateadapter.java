 ...
 */
public class Completedonateadapter<T> extends BaseAdapter {
    ...
    public Completedonateadapter(Query mRef, Class<T> mModelClass, int mLayout, Activity activity) {
        this.mRef = mRef;
        ...
        mListener = this.mRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
                ...
                try {Log.e("key","peep");
                    T model = dataSnapshot.getValue(Completedonateadapter.this.mModelClass);
                    DonateBookInfo orderClass = (DonateBookInfo) model;
                   if(orderClass.getEmail().equals(NavActivity.email))
                    Log.e("keyssss",NavActivity.email);
                    if( orderClass.getStatus().equals("PENDING")) Log.e("keyppp",NavActivity.email);
                    if (orderClass.getEmail().equals(NavActivity.email) && orderClass.getStatus().equals("PENDING")) {
                        ...
                        Log.e("keylo",orderClass.getEmail());
                        mModels.add(0, model);
                        mKeys.add(0, key);
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String s) {
               ...
               String key = dataSnapshot.getKey();
                T newModel = dataSnapshot.getValue(Completedonateadapter.this.mModelClass);
            ...
            public void onChildRemoved(DataSnapshot dataSnapshot) {
                ...
                if(orderClass.getmanager().equals(SigninActivity.myemail)&&(orderClass.getstatus()==4||orderClass.getstatus()==5||orderClass.getstatus()==6)&&orderClass.m==1) {
                    int index = mKeys.indexOf(key);
